...
def test_prediction(app, client, auth):
    ...
    response = client.put(
        '/HousePricePrediction?longitude=8.247756856706363&latitude=47.44192855&postal_code=5244&city=Birrhard&bulding_category=Einfamilienhaus&build_year=1990&living_area=187&num_rooms=6.5&user_id=1'
    )
